...
import type { AppErrorCode, AppErrorPayload } from '../types/errors.js'
import type {
  ProviderProfile,
  ModelDefinition,
  ActiveModel,
...
import type { AppLanguage } from '../constants/language.js'
import type { ProtocolId } from '../constants/protocols.js'
import type { AppTheme } from '../constants/theme.js'
import type {
  AgentStateSnapshot,
  AgentWorkspace,
  FilePreview,
...
import type { ToolPreset } from '../workspace/tool-presets.js'
import type {
  AgentHandoff,
  AgentTemplate,
  HarnessAgent,
...
import type { MascotStyle } from '../constants/mascot.js'
import type { NavItemId } from '../constants/navigation.js'
import type {
