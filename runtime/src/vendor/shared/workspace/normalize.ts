// @ts-nocheck
import type { AgentMessage, AssistantMessage, ToolCallContent } from '../types/workspace.js'
...
function streamingRawInput(block: Record<string, unknown>): string | undefined {
  ...
  const property =
    customInput && typeof customInput.property === 'string' ? customInput.property : null
