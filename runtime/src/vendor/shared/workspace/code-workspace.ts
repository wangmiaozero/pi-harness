...
import type { WorkspaceFolderRole } from '../types/workspace.js'
import { isWindowsAbsolutePath, toSlashPath } from './paths.js'
import { projectIdentityKey } from './project-identity.js'
import { projectDisplayName } from './session-tree.js'
