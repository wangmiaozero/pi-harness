// @ts-nocheck
import { normalizeStreamingToolCalls } from './normalize.js'
import type { AgentMessage, AssistantContentBlock, AssistantMessage } from '../types/workspace.js'
import type { ClientAssistantMessageEvent } from './agent-event-wire.js'
