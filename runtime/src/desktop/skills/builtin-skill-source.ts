...
import type { BuiltinSkillCategory } from '../../vendor/shared/ipc/api-types.js'
import { parseSkillDirectory } from '../capabilities/skill-parser.js'
import { SkillMutationError } from '../services/errors.js'
import builtinSources from '../../vendor/shared/skills/builtin-sources.json' with { type: 'json' }
