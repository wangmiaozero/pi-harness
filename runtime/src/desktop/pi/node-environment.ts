...
import type { NodeRuntimeInfo } from '../../vendor/shared/ipc/api-types.js'
import { managedNodeRoot, npmUserPrefix } from '../services/app-paths.js'
import {
  resolveExecutable,
  resolveLoginShellPath,
  type ResolvedExecutable
} from '../environment/command-resolver.js'
import { inspectNpmPrefix, npmBinDirectory } from '../environment/npm-environment.js'
