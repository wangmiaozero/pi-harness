...
import { environmentDownloadsDir, managedNodeRoot } from '../services/app-paths.js'
import { EnvironmentError } from '../services/errors.js'
import {
  detectNodeRuntime,
  isNodeVersionSupported,
  managedNodeBinDirectory,
  normalizeNodeVersion
} from '../pi/node-environment.js'
import { persistUserPath, refreshRuntimePath } from './path-manager.js'
import { readExecutableVersion } from './command-resolver.js'
