...
import type { DiscoveredProviderModel, ProviderProfile } from '../../vendor/shared/types/domain.js'
import type { ProviderForm, ProviderModelDiscoveryInput } from '../../vendor/shared/schemas/domain.js'
import { providerFormSchema, providerModelDiscoverySchema } from '../../vendor/shared/schemas/domain.js'
import type { JsonStore } from './storage.js'
import type { AppMetadata } from './metadata-store.js'
import { NotFoundError, ValidationError } from './errors.js'
import { secretStore } from '../security/secret-store.js'
import type { PiConfigService, WriteOptions } from '../pi/config-service.js'
import {
  domainProviderToPi,
  domainModelToPi,
  providerToDomain,
...
import type { ConnectionTestResult } from '../../vendor/shared/ipc/api-types.js'
import { getProtocol, isProtocolId } from '../../vendor/shared/constants/protocols.js'
import type { ProtocolId } from '../../vendor/shared/constants/protocols.js'
import { log, redactSecretText } from './logger.js'
import { normalizeProviderBaseUrl, volcenginePlanKind } from '../../vendor/shared/utils/base-url.js'
import type { PiProviderConfig } from '../../vendor/shared/types/pi.js'
...
function ensureDefaultModel(
  provider: import('../../vendor/shared/types/pi.js').PiProviderConfig,
  defaultModelId: string | null,
  protocol: import('../../vendor/shared/constants/protocols.js').ProtocolId,
  catalogModel: {
    id: string
    name: string
...
): import('../../vendor/shared/types/pi.js').PiProviderConfig {
