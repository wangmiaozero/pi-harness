...
import { piEnvironment } from '../pi/environment.js'
import { atomicWriteText, fileMtime, readTextFile } from './storage.js'
import { log } from './logger.js'
import type { AppSettings } from '../../vendor/shared/ipc/api-types.js'
import type { JsonStore } from './storage.js'
import { AppError, ValidationError, FileSystemError, SkillConflictError } from './errors.js'
import { capabilityBackupDir } from './app-paths.js'
import { PiPackageManager, packageNameFromSource } from '../packages/package-manager.js'
import type { BuiltinSkillService } from '../skills/builtin-skill-service.js'
import type { FileAccessService } from '../files/file-access-service.js'
import { buildBuiltinSkillBundles } from '../../vendor/shared/skills/builtin-bundles.js'
import { PiPackageRegistry } from '../packages/pi-package-registry.js'
...
export { packageNameFromSource, resolveInstalledPackagePath } from '../packages/package-manager.js'
