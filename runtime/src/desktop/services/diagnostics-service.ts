...
import type { AppSettings, DiagnosticsReport } from '../../vendor/shared/ipc/api-types.js'
import type { JsonStore } from './storage.js'
import { piEnvironment } from '../pi/environment.js'
import type { PiConfigService } from '../pi/config-service.js'
import { APP_VERSION } from '../../vendor/shared/constants/index.js'
import { atomicWriteText } from './storage.js'
import path from 'node:path'
import { userData } from './app-paths.js'
import { secretStore } from '../security/secret-store.js'
import type { SessionService } from '../../compat/workspace-stub.js'
import type { AgentRuntime } from '../../compat/workspace-stub.js'
...
import { resolveExecutable } from '../environment/command-resolver.js'
