...
import type { CapabilityDefinition, CapabilityMutationPhase } from '../../vendor/shared/capabilities/types.js'
import { resolveNpmExecutable } from '../pi/node-environment.js'
import { capabilityBackupDir } from '../services/app-paths.js'
import { SkillMutationError } from '../services/errors.js'
import { redactSecretText } from '../services/logger.js'
import { parseSkillDirectory, type ParsedSkill } from './skill-parser.js'
