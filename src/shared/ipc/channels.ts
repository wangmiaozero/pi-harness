...
export const IPC_INVOKE = {
  ...
  harnessGetRunDetail: invoke('harness:get-run-detail'),
  harnessGetRunTree: invoke('harness:get-run-tree'),
  harnessCompareRuns: invoke('harness:compare-runs'),
  harnessForkRun: invoke('harness:fork-run'),
  harnessSetBaseline: invoke('harness:set-baseline'),
  harnessGetBaseline: invoke('harness:get-baseline'),
  harnessGetProjectStats: invoke('harness:get-project-stats'),
  harnessExportRun: invoke('harness:export-run'),
  harnessExportDebugBundle: invoke('harness:export-debug-bundle'),
  harnessListArtifacts: invoke('harness:list-artifacts'),
  harnessGetStoreSettings: invoke('harness:get-store-settings'),
  harnessUpdateStoreSettings: invoke('harness:update-store-settings'),
  ...
  // Harness Control Plane — Multi-Agent Orchestration
  orchestrationList: invoke('orchestration:list'),
  orchestrationGet: invoke('orchestration:get'),
  orchestrationCreate: invoke('orchestration:create'),
  orchestrationDelete: invoke('orchestration:delete'),
  orchestrationStart: invoke('orchestration:start'),
  orchestrationPause: invoke('orchestration:pause'),
  orchestrationResume: invoke('orchestration:resume'),
  orchestrationAbort: invoke('orchestration:abort'),
  orchestrationSnapshot: invoke('orchestration:snapshot'),
  orchestrationListTemplates: invoke('orchestration:list-templates'),
  orchestrationSaveTemplate: invoke('orchestration:save-template'),
  orchestrationDeleteTemplate: invoke('orchestration:delete-template'),
  orchestrationListTeams: invoke('orchestration:list-teams'),
  orchestrationSaveTeam: invoke('orchestration:save-team'),
  orchestrationDeleteTeam: invoke('orchestration:delete-team'),
  orchestrationListAgents: invoke('orchestration:list-agents'),
  orchestrationAddAgent: invoke('orchestration:add-agent'),
  orchestrationUpdateAgent: invoke('orchestration:update-agent'),
  orchestrationDeleteAgent: invoke('orchestration:delete-agent'),
  orchestrationSetAgentBudget: invoke('orchestration:set-agent-budget'),
  orchestrationListTasks: invoke('orchestration:list-tasks'),
  orchestrationCreateTask: invoke('orchestration:create-task'),
  orchestrationUpdateTask: invoke('orchestration:update-task'),
  orchestrationDeleteTask: invoke('orchestration:delete-task'),
  orchestrationRetryTask: invoke('orchestration:retry-task'),
  orchestrationSkipTask: invoke('orchestration:skip-task'),
  orchestrationReassignTask: invoke('orchestration:reassign-task'),
  orchestrationListHandoffs: invoke('orchestration:list-handoffs'),
