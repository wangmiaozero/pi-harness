...
describe('IPC schemas', () => {
  ...
  it('accepts known settings only', () => {
    ...
    expect(appSettingsPatchSchema.safeParse({ composerFireEnabled: 'off' }).success).toBe(false)
    expect(appSettingsPatchSchema.safeParse({ language: 'auto' }).success).toBe(true)
    expect(appSettingsPatchSchema.safeParse({ language: 'ja-JP' }).success).toBe(true)
    expect(appSettingsPatchSchema.safeParse({ language: 'zh-TW' }).success).toBe(true)
