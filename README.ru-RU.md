...
| **Рабочая область** | Проекты, сессии, безопасный потоковый Markdown, сворачиваемые результаты инструментов, лёгкое редактирование кода, Git Diff и Worktree |
...
| **Настройки**       | 简体中文 / English / 한국어 / Русский / Français / Deutsch, темы, плотность, резервные копии, необязательный маскот                    |
