...
[GitHub Releases](https://github.com/wangmiaozero/pi-harness/releases/tag/v1.3.0) から Pi-Harness v1.3.0 をダウンロードしてください。
...
> macOS のコミュニティビルドは署名されていない場合があります。初回起動がブロックされた場合は、**システム設定 → プライバシーとセキュリティ → このまま開く**を使用してください。詳細は [v1.3.0 リリースノート](https://github.com/wangmiaozero/pi-harness/releases/tag/v1.3.0)を参照してください。
