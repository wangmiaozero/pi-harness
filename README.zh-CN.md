...
<p align="center">
  <a href="https://github.com/wangmiaozero/pi-harness/releases/tag/v1.3.0"><img alt="v1.3.0 发布版" src="https://img.shields.io/badge/release-v1.3.0-4C8DFF?style=flat-square" /></a>
...
从 [GitHub Releases](https://github.com/wangmiaozero/pi-harness/releases/tag/v1.3.0) 下载 Pi-Harness v1.3.0。
...
> macOS 社区构建可能没有签名。首次启动若被系统拦截，请前往“系统设置 → 隐私与安全性 → 仍要打开”。详细说明见 [v1.3.0 Release Notes](https://github.com/wangmiaozero/pi-harness/releases/tag/v1.3.0)。
